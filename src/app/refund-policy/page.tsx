  ...
  return (
    <LegalLayout title="Refund Policy" lastUpdated="June 2026">
      ...
      <section>
        ...
        <p>
          If we cannot find useful grant deadline or reporting information in the
          documents you share after payment, we will refund the full $49 setup
          fee.
        </p>
        <p>
          This applies when the documents you provide do not contain
          identifiable report due dates, renewal dates, or reporting
          requirements that we can extract into a meaningful tracker.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          Once the deadline tracker, reminder schedule, and summary have been
          delivered to you, refund requests are handled on a case-by-case basis.
          If you believe the delivered tracker does not reflect the information
          in your documents, please reach out and we will work with you to
          resolve the issue.
        </p>
      </section>
